...
module.exports = function (argv) {
  const options = require('dreamopt')(
    [
      ...
      '  -p, --precision PREC    Round all floating point numbers to this number of decimal places prior to comparison'
    ],
    argv
  )
  ...
  if (options.precision != undefined) {
      json1 = roundObj(json1, options.precision);
      json2 = roundObj(json2, options.precision);
  }
